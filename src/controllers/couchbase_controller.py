...
class CouchbaseController:
    ...
    def __init__(self, environment: str, config_dir: Path = None, host: str = None, username: str = None, password: str = None, tls: bool = None):
    ...
    def ensure_initialized(self) -> None:
        ...
        print("Ensuring Couchbase cluster is initialized...")
    ...
    def _wait_for_bucket_ready(self, cluster: Cluster, bucket_name: str, max_retries: int = 30, retry_interval: int = 2) -> None:
        ...
        for attempt in range(max_retries):
            try:
                ...
                print(f"Bucket '{bucket_name}' not ready yet, waiting... (attempt {attempt + 1}/{max_retries})")
                time.sleep(retry_interval)
    ...
    def ensure_bucket(self, bucket_name: str, settings: Dict[str, Any]) -> None:
        ...
        try:
            ...
            print(f"Waiting for bucket '{bucket_name}' to be ready...")
    ...
    def _load_couchbase_config(self, config_dir: Path) -> Dict[str, Any]:
        """Load Couchbase configuration from YAML file."""
        config = Config(config_dir, "")  # Environment not needed for loading
        return config.load_yaml('couchbase.yaml')
    ...
    def run_ops(self) -> None:
        ...
        print("Processing Couchbase resources...")
        ...
        cluster = self.connect_with_retry()
        print("Couchbase cluster is ready and initialized.")
        
        # Load configuration and ensure resources
        couchbase_config = self._load_couchbase_config(self.config_dir)
        self._ensure_resources(couchbase_config)
        print("Couchbase resources processed successfully")
